        ...
        <div className="p-4 space-y-4">
          ...
          {subscribers && !rawMode && (
            <div className="space-y-2">
              ...
              <div className="text-[10px] text-[#475569] bg-[#0a0e1a] border border-[#1e3a5f]/40 rounded px-2 py-1.5 col-span-2">
                ⚙ Sergek: число муфт/ОРК и тип ОК OLT→муфта считаются автоматически по камерам.
                ОРК — паук 1:16. После правки муфты/ОРК — «Перестроить кабели»; слияние — отдельно ②.
              </div>
            </div>
          )}
        </div>
