...
2a. Выполнить `docs/supabase-journal.sql` — общий журнал стройки (дневные
    отчёты, отклонения, колонны). Без него журнал остаётся в localStorage
    каждого браузера, и бригады не видят работу друг друга.
